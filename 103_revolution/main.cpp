...
void MyAppDelegate::applicationDidFinishLaunching(NS::Notification* pNotification) {
    ...
    _pWindow->setTitle(NS::String::string("103 - Revolution", NS::StringEncoding::UTF8StringEncoding));
...
void Renderer::buildBuffers() {
    ...
    simd::float3 positions[NumVertices] = {
        {0.0f,  y, 0.0f},
        {static_cast<float>(-y*std::sqrt(3)/2.0), -y/2, 0.0f},
        {static_cast<float>(y*std::sqrt(3)/2.0),  -y/2, 0.0f}
    };
